...
export class Events {
    ...
    shakeCard(cardName) {
        ...
        const cardLeftValue = cardObject.getLeft();
    ...
    applyCard(player, cardName) {
        ...
        const cardObject = this.cards.getCardObject(cardName);
        const playerOne = (player === that.playerOne) ? that.playerOne : that.playerTwo;
        const playerTwo = (player === that.playerOne) ? that.playerTwo : that.playerOne;
    ...
    discardCard(player, cardName) {
        ...
        if (that.game.isOn() && that.game.getPlayerTurn(playerOne)) {
            if (that.game.cardAvailable(cardName, playerOne)) {
                ...
                const cardObjectTop = cardObject.getTop();
