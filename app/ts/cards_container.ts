...
export class ArcomageCardsContainer {

    public cardsArray: any;
    public backOfCardSrc: string;
    public discardTxt: string;
    ...
    constructor() {
        this.cardsArray = {
            amethyst: {
                ...
                action: (player: Player, enemy: Player) => {
            ...
            shift: {
                ...
                action: (player: Player, enemy: Player) => {
                    ...
                    const playerWall: number = player.wallLife;
                    const enemyWall: number = enemy.wallLife;
            ...
            thief: {
                ...
                action: (player: Player, enemy: Player) => {
                    const enemyGems: number = ((enemy.resources.gems - 10) > 0)
                        ? (enemy.resources.gems - 10)
                        : enemy.resources.gems;
                    const enemyBricks: number = ((enemy.resources.bricks - 6) > 0)
